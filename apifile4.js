...
/* 
function escribir_contenido(fileWriter){ *//* el parámetro fileWriter se crea al ejecutar el método createWriter */
/* 
    var texto = document.getElementById("texto").value;

    fileWriter.onwriteend = exito();
 */
    /* procedemos ahora en transformar el texto en formato blob de la siguiente manera */
/* 
